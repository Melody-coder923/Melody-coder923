...
### 2. [micrograd](https://github.com/Melody-coder923/micrograd)
- Neural network implementation in Python.
- Focuses on understanding how neural networks work by implementing backpropagation from scratch.

### 3. [Weekly-DSA-Journey](https://github.com/Melody-coder923/Weekly-DSA-Journey)
...
### 5. [final-project-digital-marketing-solar-sisters](https://github.com/Melody-coder923/final-project-digital-marketing-solar-sisters)
...
### 6. [Deep-Learning-Training-and-Evaluation-with-DeepSpeed-and-PyTorch](https://github.com/Melody-coder923/Deep-Learning-Training-and-Evaluation-with-DeepSpeed-and-PyTorch)
- Large-scale deep learning model training and evaluation with DeepSpeed and PyTorch.
- DeepSpeed, PyTorch, Machine Learning

### 7. [transformers](https://github.com/Melody-coder923/transformers)
- The model-definition framework for state-of-the-art machine learning models in text, vision, audio, and multimodal models for both inference and training.
- Contributed to the open-source community by improving the usability and performance of this powerful library.
- Python, PyTorch, TensorFlow
